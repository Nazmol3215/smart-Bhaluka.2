        ...
        <div>
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            <button 
              ...
              style={{...buttonStyle, backgroundColor: darkMode ? '#ff9800' : '#333', color: '#fff'}}
            >
            ...
            <div>
              {users.map(user => (
                <div key={user._id} style={cardStyle}>
                  <p><strong>{user.name}</strong> ({user.type}) - {user.address}</p>
                  <button 
              ...
              <div style={{
                ...
                <div style={{display: 'flex', justifyContent: 'space-between'}}>
                  <button 
                    ...
                    style={{...buttonStyle, backgroundColor: '#4CAF50', color: '#fff', width: '48%'}}
                  >
                    আপডেট
                  </button>
                  <button 
                    onClick={() => setEditUser(null)}
                    style={{...buttonStyle, backgroundColor: '#f44336', color: '#fff', width: '48%'}}
                  >
                    বাতিল
                  </button>
                </div>
